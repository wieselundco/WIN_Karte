...
mymap <- tm_shape(gemeinden_projekte2, name = "Projekte") + 
  tm_polygons(alpha = 0.5, col = "projektbezeichnung",legend.show = TRUE,popup.vars = c("projektbezeichnung", "projektperimeter_gemeinde", "stand", "laufzeit", "projektleiter", "tragerschaft"))
