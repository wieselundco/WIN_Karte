...
mycols <- colorRampPalette(RColorBrewer::brewer.pal(12, "Set3"))(nrow(gemeinden_projekte2))

shapes <- gemeinden_projekte2 %>%
  select(projektbezeichnung) %>%
